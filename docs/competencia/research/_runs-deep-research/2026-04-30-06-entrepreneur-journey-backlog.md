...
!!! note ":material-check-decagram: Decisiones del equipo (30-abr-2026)"
    ...
    El catálogo de **60 features candidatas** que generan estos dolores está en [Sección 4](#seccion-4-catalogo-de-funcionalidades-candidatas-backlog) más abajo, con sus propias marcas. Versión curada: [Backlog Tu Plata Mipyme](../../../tu-plata-mipyme/backlog.md).
