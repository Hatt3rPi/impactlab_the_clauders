...
- [ ] Lectura del [Agent SDK](../../../tu-plata-mipyme/especificaciones/stack/agent-sdk.md) actualizado.
- [ ] [MCPs disponibles](../../../tu-plata-mipyme/especificaciones/stack/mcps.md) y cómo crear uno custom.
