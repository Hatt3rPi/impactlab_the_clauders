---
title: "Enlaces del run Deep Research #01"
description: "URLs citadas por el agente Google Deep Research Max para el run #01: Ideas fuera del radar para literacy regulatoria con IA en Chile."
tags:
  - recursos
  - enlaces
  - run-01
...
# Enlaces del run Deep Research #01 — Ideas fuera del radar para literacy regulatoria con IA en Chile

<!-- AUTO-BANNER -->
!!! info ":material-book-open-variant: Síntesis de fuentes externas"
    Lista de URLs citadas por el agente Google Deep Research Max en el run [`run-01`](../../research/_runs-deep-research/2026-04-29-01-ideas-fuera-del-radar.md). **Verificar contra fuente primaria antes de citar en el pitch.**
