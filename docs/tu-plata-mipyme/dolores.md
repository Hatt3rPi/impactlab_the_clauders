---
title: "Dolores del journey del microemprendedor chileno"
description: "Mapa exhaustivo de los 48 dolores que enfrenta el microemprendedor chileno en las 6 etapas del journey (idea → cierre), con la decisión del equipo sobre cuáles atacar."
tags:
  - tu-plata-mipyme
  - dolores
  - journey
...
# Dolores del journey del microemprendedor chileno

<!-- AUTO-BANNER -->
!!! success ":material-check-bold: Producido por el equipo"
    Documento canónico del producto. Mapa de **48 dolores documentados** en las 6 etapas del journey, con la decisión literal de la [reunión del 30-abr-2026](../reuniones/2026-04-30-revision-dolores-backlog.md). Insumo principal del [Backlog](./backlog.md) (las soluciones).

> *El viaje del microemprendedor chileno desde el sueño hasta la PYME está minado de obstáculos. Aquí detallamos cada uno con su forma actual de resolverse, su costo y la brecha donde una IA conversacional puede aportar valor real.*

## Cómo se relaciona con otros documentos

| Documento | Qué contiene |
|---|---|
| [**Dolores** (este doc)](./dolores.md) | Los **problemas** que vive el microemprendedor en cada etapa. |
| [Backlog](./backlog.md) | Las **60 features** (soluciones) que respondemos a estos dolores. |
| [Plan de implementación](./plan.md) | Cómo construimos el producto que aborda estos dolores. |
| [Run #06 raw](../competencia/research/_runs-deep-research/2026-04-30-06-entrepreneur-journey-backlog.md) | Reporte completo de Deep Research de donde se promovió este contenido. |

## Resumen del estado por etapa

| Etapa | Dolores | ✅ Incluir | ❌ Excluir | 💡 Guiño | ⏳ Pendiente |
|---|---|---|---|---|---|
| E0 — Idea / Sueño | 8 | 6 | 2 | 0 | 0 |
| E1 — Validación informal | 8 | 4 | 4 | 0 | 0 |
| E2 — Formalización | 8 | 7 | 0 | 1 | 0 |
| E3 — Operación formal | 8 | 3 | 5 | 0 | 0 |
| E4 — Crecimiento | 8 | 3 | 5 | 0 | 0 |
| E5 — Recuperación / cierre | 8 | 2 | 6 | 0 | 0 |
| **Total** | **48** | **25** | **22** | **1** | **0** |

**Etapa más madura:** E2 — Formalización (7 de 8 incluidas + 1 guiño). El equipo declaró: *"es nuestro fuerte hasta el momento."*

**Backlog del producto cerrado (30-abr):** **25 dolores ✅ Incluir** definen el alcance V1. Los 22 ❌ Excluir quedan documentados con su justificación (off-target del producto, derivación a Marketplace, complejidad legal que requiere abogado/contador). **Cero pendientes** — las 6 etapas revisadas.

---

## Mapa del journey por etapas (E0-E5)
...
!!! note ":material-check-decagram: Decisiones del equipo (30-abr-2026)"
    Cada dolor lleva al final de su título la decisión del equipo y un bullet **"Decisión equipo (30-abr)"** con la nota literal de la [reunión del 30-abr-2026](../reuniones/2026-04-30-revision-dolores-backlog.md):

    - ✅ **Incluir** — dolor que el equipo aprobó atacar (con su variante: `con disclaimer`, `como warning IA`, `como pregunta diagnóstica`, etc.).
    - ❌ **Excluir** — descartado (fuera de alcance, redundante, o cae en otra línea como ciberseguridad).
    - 💡 **Guiño / futuro** — no priorizado pero se menciona como logro/checklist al usuario avanzado.
    - ⏳ **Pendiente** — el equipo aún no lo revisó (E3-D4 a D8 + E4 + E5 completas; corte por tiempo en la reunión).

    Para las **60 features candidatas que dan respuesta a estos dolores**, ver [Backlog Tu Plata Mipyme](./backlog.md).
...
**1. Dolor: Autopercepción de "no soy empresaria" (Síndrome del impostor socioeconómico).** — ❌ Excluir
...
- **Decisión equipo (30-abr):** ❌ Excluir. Jose: "es algo emocional, no se resuelve con un chatbot".

**2. Dolor: Miedo irracional al Servicio de Impuestos Internos (SII).** — ✅ Incluir (CRÍTICO + transversal)
...
- **Decisión equipo (30-abr):** ❌ Excluir. "Llegamos tarde con este dolor — atendemos a quien ya sabe qué quiere hacer".

**5. Dolor: Fricción cognitiva sobre "qué permisos necesito".** — ✅ Incluir
...
**1. Dolor: Ventas sin RUT comercial (imposibilidad de emitir facturas a empresas).** — ✅ Incluir
...
- **Decisión equipo (30-abr):** ❌ Excluir como dolor independiente. Tratado como disclaimer dentro del checklist de permisos. No agregar feature dedicada.

**4. Dolor: Estafas por falsas transferencias (Pantallazos adulterados).** — ❌ Excluir
...
- **Decisión equipo (30-abr):** ❌ Excluir. "Cae en ciberseguridad y choca con otro pilar del lab. Cotota la idea, pero descartada".

**5. Dolor: Desorden de inventario básico.** — ❌ Excluir
...
- **Decisión equipo (30-abr):** ❌ Excluir. "No apunta a la línea del proyecto (inclusión financiera). Buena idea pero fuera de alcance".

**6. Dolor: Costos de despacho informales (Delivery no optimizado).** — ❌ Excluir
...
- **Decisión equipo (30-abr):** ❌ Excluir. "Cloud/GPT puede responder eso solo, no necesitamos invertir".

**7. Dolor: Crecimiento invisible (No saber si hay ganancias reales).** — ✅ Incluir
...
**1. Dolor: Fricción técnica en "Tu Empresa en Un Día" (RES).** — ✅ Incluir como acompañamiento
...
**3. Dolor: El abismo entre la escritura (RES) y el SII (Formulario 4415).** — ✅ Incluir como continuación de etapa
...
- **Decisión equipo (30-abr):** 💡 Guiño / logro futuro. Excluido del alcance principal: "quien piensa en INAPI ya está formado". Tratarlo como "checklist de cosas que podrías hacer en algún momento".

**8. Dolor: Sobrecarga de firmas electrónicas (FEA vs FE Simple vs Token).** — ✅ Incluir como quick win
...
**1. Dolor: Declaración Mensual de Impuestos (F29).** — ✅ Incluir
...
- **Decisión equipo (30-abr):** ❌ Excluir generación automática. Afuera por complejidad técnica. Dirigir a soluciones existentes (Bsale, Defontana, SII Mipyme). **Mantenemos rol de información, no de ejecución.**

**3. Dolor: Elección y Comprensión del Régimen Tributario.** — ✅ Incluir, **pero en E2**
