...
| E3 — Operación formal | 8 | 3 | 1 | 0 | 4 |
| E4 — Crecimiento | 8 | 3 | 0 | 0 | 5 |
| E5 — Recuperación / cierre | 8 | 2 | 0 | 0 | 6 |
| **Total** | **48** | **25** | **7** | **1** | **15** |

**Etapa más madura:** E2 — Formalización (7 de 8 incluidas + 1 guiño). El equipo declaró: *"es nuestro fuerte hasta el momento."*

**Última actualización (30-abr post-reunión):** el equipo sumó 6 dolores ✅ en la sesión complementaria (E3-D8 multas SII; E4-D2 subsidios, E4-D3 FOGAPE, E4-D5 PreviRed con recordatorio; E5-D4 suspensión SII activable al "eliminar cuenta", E5-D5 disolución RES).
